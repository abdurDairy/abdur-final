    ...
    <body class="main">
        ...
        <div class="mobile-menu d-md-none">
            <div class="mobile-menu-bar">
                <a style="width: 50px;" href="{{ route('dashboard') }}" class="d-flex me-auto">
                    <img style="width: 50px; margin:0 auto;" src="{{ asset('custom image/iiuc_logo.png') }}" alt="">
                </a>
            ...
            <ul class="mobile-menu-wrapper border-top border-theme-29 dark-border-dark-3 py-5">
                ...
                <li>
                    <a href="{{ route('admin.register') }}" class="menu">
                        ...
                        <div class="menu__title"> Create New Account </div>
                    </a>
                </li>
                <li>
        ...
        <div class="d-flex">
            <!-- BEGIN: Side Menu -->
            <nav class="side-nav">
                <a href="{{ route('dashboard') }}" style="" class="intro-x d-flex align-items-center ps-5 pt-4">
                    <img style="width: 70px; margin:0 auto;" src="{{ asset('custom image/iiuc_logo.png') }}" alt="">
                </a>
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ route('admin.register') }}" class="side-menu">
                            ...
                            <div class="side-menu__title"> Create New Account </div>
                        </a>
                    </li>
                    <li>
                    ...
                    <div class="intro-x dropdown w-8 h-8">
                        ...
                        <div class="dropdown-menu w-56">
                            <ul class="dropdown-content bg-theme-26 dark-bg-dark-6 text-white">
                                ...
                                <li>
                                        <x-dropdown-link :href="route('profile.edit')" class="dropdown-item text-white bg-theme-1-hover dark-bg-dark-3-hover">
                                            <i data-feather="user" class="w-4 h-4 me-2"></i> {{ __('Profile') }}
                                        </x-dropdown-link>
                                </li>
                                <li>
                            ...
                            <!-- Authentication -->
                            <li>
                                <a href="{{ route('admin.logout') }}" class="dropdown-item text-white bg-theme-1-hover dark-bg-dark-3-hover"> <i data-feather="toggle-right" class="w-4 h-4 me-2"></i>Logout</a>
                            </li>

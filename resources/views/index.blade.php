            ...
            <div class="single-course">
                ...
                <div class="course-position-content">
                    ...
                    <div class="course-btn">
                        <a class="default-btn" href="index.html#">APPLY NOW</a>
                    </div>
                </div>
            </div>
            <div class="single-course">
                    ...
                    <div class="row g-0">
                        <div class="ms-auto col-lg-6 col-md-12">
                            <div class="testi-content bg-img default-overlay"
                                ...
                                <p>Lorem ipsum dolor sit amet, conse ctetur adipi sicing elit, sed do eiusm od
                                    tempor incidi dunt ut labore et dolore magna aliqua. Ut enim fugiat nulla
                                    pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui. Sed
                        ...
                        <div class="teacher-content">
                            ...
                            <div class="teacher-social">
                                <ul>
                                    ...
                                    <li><a class="youtube-play" href="index.html#"><i
                                                class="fa fa-youtube-play"></i></a></li>
                                    <li><a class="twitter" href="index.html#"><i class="fa fa-twitter"></i></a></li>
                                    <li><a class="google-plus" href="index.html#"><i
                ...
                <div class="single-blog mb-30">
                    ...
                    <div class="blog-content-wrap">
                        ...
                        <div class="blog-content">
                            ...
                            <div class="blog-meta">
                                <ul>
                                    <li><a href="index.html#"><i class="fa fa-user"></i> Adrin Azra</a></li>
                                    <li><a href="index.html#"><i class="fa fa-comments-o"></i> 15</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="blog-date">
                            <a href="index.html#"><i class="fa fa-calendar-o"></i> Jun, 24th 2018</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="single-blog mb-30">
                    ...
                    <div class="blog-content-wrap">
                        ...
                        <div class="blog-content">
                            ...
                            <div class="blog-meta">
                                <ul>
                                    <li><a href="index.html#"><i class="fa fa-user"></i> Tayeb Jon</a></li>
                                    <li><a href="index.html#"><i class="fa fa-comments-o"></i> 12</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="blog-date">
                            <a href="index.html#"><i class="fa fa-calendar-o"></i> Feb, 18th 2017</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="single-blog mb-30">
                    ...
                    <div class="blog-content-wrap">
                        ...
                        <div class="blog-content">
                            ...
                            <div class="blog-meta">
                                <ul>
                                    <li><a href="index.html#"><i class="fa fa-user"></i> Rifat Al</a></li>
                                    <li><a href="index.html#"><i class="fa fa-comments-o"></i> 20</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="blog-date">
                            <a href="index.html#"><i class="fa fa-calendar-o"></i> Oct, 14th 2018</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="single-blog mb-30">
                    ...
                    <div class="blog-content-wrap">
                        ...
                        <div class="blog-content">
                            ...
                            <div class="blog-meta">
                                <ul>
                                    <li><a href="index.html#"><i class="fa fa-user"></i>Md Tamim</a></li>
                                    <li><a href="index.html#"><i class="fa fa-comments-o"></i> 08</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="blog-date">
                            <a href="index.html#"><i class="fa fa-calendar-o"></i> Jun, 21th 2017</a>
                        </div>
                    </div>
                </div>
            </div>
